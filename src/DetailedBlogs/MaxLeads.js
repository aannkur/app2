...
export default function MaxLeads({ posts, isLoading }) {
    return isLoading ? (
        <Animation />
    ) : (
        <div>
                ...
                <Container className=" mt-4 mb-5 center " style={{ width: "73rem" }}>
                    <div >
                        {posts.map((item, index) => {
                            return item?.id == '6026' ? (
                                <div className=" column">
                                     <h4 className="center bold7 ">{item?.acf?.title_3}</h4>
                ...
                <Container className=" mt-4 mb-5 center " style={{ width: "73rem" }}>
                    <div >
                        {posts.map((item, index) => {
                            return item?.id == '6026' ? (
                                <div className=" column">
                                    <h4 className=" center bold7 ">{item?.acf?.title_4}</h4>
                ...
                <Container className=" mt-4 mb-5 center " style={{ width: "73rem" }}>
                    <div >
                        {posts.map((item, index) => {
                            return item?.id == '6026' ? (
                                <div className=" column">
                                   <h4 className=" center bold7 ">{item?.acf?.title_5}</h4>
                ...
                <Container className=" mt-4 mb-5 center " style={{ width: "73rem" }}>
                    <div >
                        {posts.map((item, index) => {
                            return item?.id == '6026' ? (
                                <div className=" column">
                                    <h4 className="center bold7 ">{item?.acf?.title_7}</h4>
