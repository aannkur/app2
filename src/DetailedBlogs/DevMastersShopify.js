...
export default function DevMasters({ posts, isLoading }) {
                ...
                <Container className="  mb-5 center " style={{ width: "73rem" }}>
                    <div >
                        {posts.map((item, index) => {
                            return item?.id == '5508' ? (
                                <div className=" column">
                                    <h4 className=" bold7 mt-5 red">{item?.acf?.title_4}</h4>
                        ...
                        {posts.map((item, index) => {
                            return item?.id == '5508' ? (
                                <div className=" column">
                                    ...
                                    <h5 className=" red mb-5">{item?.acf?.text_1}</h5>
                                    <h5 className=" red">{item?.acf?.text_2}</h5>
                                </div>
